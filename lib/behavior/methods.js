...
var getOption = function(name) {
  ...
  // Get the "sort" behavior.
  var schema = _.find(schemas, function(schema) {
    return schema.hasBehavior('sort');
  });
  var behavior = schema.getBehavior('sort');

  return behavior.options[name];
};

var getCollection = function() {
  return this.constructor.schema.getCollection();
};
